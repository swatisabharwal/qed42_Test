...
public class SeleniumWait{
    ...
    public boolean waitForPageUrlToContain(String expectedPagetitle) {
        return wait.until(ExpectedConditions.urlContains(expectedPagetitle)) != null;
    }
	...
	public List<WebElement> checkPresenceOfElementsInDom(By loc)
    {
	 ...
	 public void waitForElementsSizeToBeEqualToOne(List<WebElement> element) {
    	int count=0;
    	while(count<=30) {
    		if(element.size()>=1) {
    			break;
